                ...
                <div class="section_main_content mt-4">
                    <div class="container m-4 p-4">
                        ...
                        <div class="submit_home_work_section mt-4">
                            <div class="container">
                                <div class="section_title text-center fs-4 pb-4 mb-4">
                                    Here is your homework inspection result
                                </div>
...
<div class="user_info_main_section mt-4 mb-4">
    ...
    <input type="hidden" name="submitted_user_id" value="<?php echo $submitted_user_id ?>">
                                        ...
                                        <select name="homework_id" id="" class="form-control me-4 pe-4">
                                            ...
                                            <?php
                                            if(!isset($_GET['homework_id']) || $_GET['homework_id'] == ''){
                                                echo '
                                                <script>
                                            ...
                                            if(!isset($_GET['homework_problem_id']) || $_GET['homework_problem_id'] == ''){
                                                echo '
                                                <script>
                                                location.href = "/manage_submitted_homeworks";
                                                </script>
                              ...
                              <div class="integrate_code_editor">
                                ...
                                ?>
                                    ...
                                    <div class="mb-3 me-4 pe-4">
                                        ...
                                        <select name="homework_inspection_result" disabled id="homework_inspection_result" class="form-control me-4 pe-4 mt-4 ">
...
<!-- 
                                    ...
                                    <div class="mb-3 mt-4 pt-4">
                                        <a href="/manage_codes" class="nav-link">
